# Hand-held suitcases and luggage datasets (2500 images) for YOLO

# Body

Hand-held suitcases (travel bags) dataset - 2500 images, YOLO format, with clear and complete annotations suitable for target detection, image segmentation, algorithm performance improvement, etc., ready to use directly, saving time and effort.
